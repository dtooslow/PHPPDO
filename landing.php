  ...
  <body>
    ...
    <div class="card">
      <div class="card-body">
        ...
        <input type="text" name="name" value="<?= !empty($editUser) ? $editUser['name'] : '' ?>" class="form-control" required><br>

        <label for="email" class="form-label">Email:</label>
        <input type="email" name="email" value="<?= !empty($editUser) ? $editUser['email'] : '' ?>" class="form-control" required><br>

        <label for="product" class="form-label">Product:</label>
        <input type="text" name="product" placeholder="Product" class="form-control" required><br>

        <label for="amount" class="form-label">Amount:</label>
        <input type="number" step="0.01" name="amount" placeholder="Amount" class="form-control" required><br>
